    ...
    <div id="services" className='bg-white py-16 px-8'>
      <div className='container mx-auto px-6 lg:px-24 text-center'>
        <div className='mb-12'>
            ...
            <h2 className='text-4xl font-bold text-[#eab949] mb-4'>Check my services</h2>
        </div>
      </div>
      <div className='grid grid-cols-1 md:grid-cols-3 gap-10'>
        <div className='bg-gray-50 rounded-lg shadow-lg p-6'>
          <div className='overflow-hidden rounded-lg mb-4'>
            ...
            <h3 className='text-2xl font-semibold text-[#eab949] mb-2'>Web Development Services</h3>
        ...
        <div className='bg-gray-50 rounded-lg shadow-lg p-6'>
          <div className="overflow-hidden rounded-lg mb-4">
            ...
            <h3 className='text-2xl font-semibold text-[#eab949] mb-2'>Creative Services</h3>
        ...
        <div className='bg-gray-50 rounded-lg shadow-lg p-6'>
          <div className="overflow-hidden rounded-lg mb-4">
            ...
            <h3 className='text-2xl font-semibold text-[#eab949] mb-2'>Additional Options</h3>
